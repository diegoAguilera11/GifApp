...
import { MyGif } from '../interfaces/gifInterfaces';
...
export const GifGrid = ({ category }: GifGridProps) => {
    ...
    const [images, setImages] = useState<MyGif[]>([]);
    ...
    return (
        <>
            {
                (isLoading) && <div className="flex justify-center items-center py-12" role="status">
            ...
            <h3 className='text-white font-bold my-10 text-4xl'>{category}</h3>
